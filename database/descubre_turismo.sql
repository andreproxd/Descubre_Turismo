...
DROP SCHEMA IF EXISTS `descubre_turismo` ;
CREATE SCHEMA IF NOT EXISTS `descubre_turismo` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
SHOW WARNINGS;
USE `descubre_turismo` ;
