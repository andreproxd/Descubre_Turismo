            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="col-xs-3 col-xs-offset-3">
                    <a href="<?php echo base_url(); ?>index.php/admin/restaurantes/create" class="btn btn-block btn-success btn-flat"><img src="<?php echo base_url(); ?>media/img/icon/admin/addadm2.png" align="left">Nuevo Restaurante</a>
                </div>
                </div>
