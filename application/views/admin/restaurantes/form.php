...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="fa fa-user"><i class="fa fa-hotel"></i>Restaurantes</a></li>
            <li class="active"></li>
          </ol>
        </section>
          <br/>
    ...
    <div class="row box principal">
        ...
        <fieldset><br/>
                    ...
                    <div class="row ">
                    <div class="col-xs-10">
                        <input id="nombre" name="nombre" type="text" placeholder="" class="form-control input-xs"value="">
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group col-xs-6">
                        <div class="row">
                            <label class="col-xs-10 text-center ">Especialidad</label>
                        </div>
                        <div class="row">
                        <div class="col-xs-10">
                            <input id="especialidad" name="especialidad" type="text" placeholder="" class="form-control input-xs"value="">
                    </div>
                        </div>
                    </div>
 ...
 <div class="form-group col-xs-12">
                <div class="row">
                    ...
                    <div class="col-xs-12 box simple1">
                        <label class="checkbox-inline"><input type="checkbox" value="">Estacionamiento</label>
                         <label class="checkbox-inline"><input type="checkbox" value="">Orquesta</label>
                         <label class="checkbox-inline"><input type="checkbox" value="">Eventos Culturales</label>
                         <label class="checkbox-inline"><input type="checkbox" value="">Servicios Higienicos</label>
                ...
                <div class="form-group">
                    <div class="col-xs-4 col-xs-offset-1">
                        <div class="row">
                            <a href="<?php echo base_url(); ?>index.php/admin/restaurantes/save" class="btn btn-block btn-success btn-flat">Agregar</a>
                        </div>
                    </div>
                    <div class="col-xs-3 col-xs-offset-1">
                        <div class="row">
                            <a href="<?php echo base_url(); ?>index.php/admin/restaurantes" class="btn btn-block btn-danger btn-flat">Cancelar</a>
                        </div>
                    </div>
                </div>
                </fieldset>
