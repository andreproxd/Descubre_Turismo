        ...
        <section class="content">
          <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-xs-offset-4">
                    <div class="row">
                         <input type="text" name="lug_direccion"class="form-control" placeholder="Direccion del Lugar">
                    </div>         <br/>
                </div>
      ...
      <div class="row">
          <div class="col-md-12">
                    <div class=" col-xs-2 col-xs-offset-2">
                        <?php echo form_label('Departamento : ', 'dpto') ?>
                        <?php echo form_dropdown('sDep', $dptos, 12, "id='sDep'");?>
                    </div>

                    <div class=" col-xs-3 ">
                        <?php echo form_label('Provincia : ', 'prov') ?>
                        <?php echo form_dropdown('sPro', $provs, 12, "id='sPro'");?>
                    </div>
        
                    <div class=" col-xs-2">
                        <?php echo form_label('Distrito : ', 'dist') ?>
                        <?php echo form_dropdown('sDep', $diss, 12, "id='sDis'");?>
                    </div>

                    </div>
        </div>
                     <input type="hidden" name="" class="form-control lat" placeholder="lat">
                     <input type="hidden"  name="" class="form-control lon" placeholder="long">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xs-6">
                            <div class="row">
                              ...
                              <div class="row">
                                <div class="dropdown col-xs-4">
                                  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1"name="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                    Seleccionar
                            ...
                            <div class="row padding_15_lef">
                                 <input type="text" name="" class="form-control" class="col-xs-3" placeholder="telefono de contacto">
                            </div>
                            </div>
                            <div class="form-group col-xs-6 ">
                            <div class="row">
...
<div  class="col-xs-12"style="position:relative;">
        <a class='btn btn-primary' href='javascript:;'>
            ...
            <input type="file" style='position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";opacity:0;background-color:transparent;color:transparent;' name="imagen" size="40"  onchange='$("#upload-file-info").html($(this).val());'>
        </a>
        &nbsp;
        <span class='label label-info' id="upload-file-info"></span>
                          ...
                          <input type="hidden" name="idlugar" name="" value="" />
                      </div>
                    </div>
                    </div>
                    </div><br/>
