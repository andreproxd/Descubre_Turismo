...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="row">
        ...
        <fieldset><br/>
                    ...
                    <div class="row">
                    <label class="col-xs-6 col-xs-offset-2  text-center control-label" for="nombre">Nombre</label>
                    </div>
                    <div class="row">
                    <div class="col-xs-6 col-xs-offset-2">
                        <input id="nombre" name="nombre" type="text" placeholder="" class="form-control input-sm" value="">
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                    <div class="row">
                        <label class="col-xs-6 col-xs-offset-2 text-center control-label" for="descripcion">Descripcion</label>
                    </div>
                     <div class="row">
                        <div class="col-xs-6 col-xs-offset-2">
                    ...
                    <div class="form-group">
                    <div class="row">
                        <label class="col-xs-6 col-xs-offset-2 text-center control-label" for="vias">Vias de Acceso</label>
                    </div>
                     <div class="row">
                        <div class="col-xs-6 col-xs-offset-2">
                            <textarea name="vias" class="form-control" rows="3" id="descripcion"></textarea>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                    <div class="row">
                    <label class="col-xs-6 col-xs-offset-2 text-center control-label" for="Sexo">Departamento</label>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                    <div class="row">
                    <label class="col-xs-6 col-xs-offset-2 text-center control-label" for="provincia">Provincia</label>
                    </div>
                    <div class="row">
                    <div class="col-xs-5 col-xs-offset-4 ">
