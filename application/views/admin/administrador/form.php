...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="row">
        ...
        <fieldset><br/>
                    ...
                    <div class="row ">
                    <div class="col-xs-6 col-xs-offset-2 input-group">
                      <input type="text"name="correo"id="correo" class="form-control" placeholder="Correo Electronico" aria-describedby="basic-addon2">
                    ...
                    <div class="row ">
                    <div class="col-xs-6 col-xs-offset-2">
                        <input id="password1" name="password1"type="password" placeholder="" class="form-control input-md"value="">
                    </div>
                    </div>
                    </div>
