...
<div class="modal fade" role="dialog" id="_iglesias">
  <div class="modal-dialog modal-lg " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"><b>Actualizar Iglesia</b></h4>
      </div>
        ...
        <div class="row  ">
            <div class="col-md-12 ">    
                ...
                <fieldset><br/>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/admin/iglesias/save" class="btn btn-primary  col-xs-3 pull-right">Agregar</a>
                  </div>
    </div><!-- /.modal -->
     </div>
</div>
