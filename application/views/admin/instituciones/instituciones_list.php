            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="col-xs-3 col-xs-offset-2">
                    <a href="<?php echo base_url(); ?>" class="btn btn-block btn-success btn-flat"><img src="<?php echo base_url(); ?>media/img/icon/admin/addadm2.png" align="left">Nueva Institucion</a>    
                </div>
                </div>
                  ...
                  <table id="example1" class=" table-bordered ">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            Lunes a Viernes de 7:30 a.m - 1:00 p.m y de 2:00 p.m a 4:15 p.m  
                        </td>
                        <td>
