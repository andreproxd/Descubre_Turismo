        ...
        <fieldset><br/>
                ...
                <div class="form-group">
                    <div class="col-xs-4 col-xs-offset-1">
                        <div class="row">
                            <a href="<?php echo base_url(); ?>index.php/public/cliente/save" class="btn btn-block btn-success btn-flat">Agregar</a>
                            <input type="button" cass=btn-success value=guardar>
                        </div>
                    </div>
