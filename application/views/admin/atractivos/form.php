...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="fa fa-user"><i class="fa fa-user"></i>Atractivos</a></li>
            <li class="active"></li>
          </ol>
        </section>
          <br/>
    ...
    <div class="row box principal">
        ...
        <fieldset><br/>
                    ...
                    <div class="form-group col-xs-6">
                    <div class="row">
                        <label class="col-xs-10 text-center  control-label" for="estacionalidad">Estacionalidad</label>
                    </div>
                    <div class="row ">
                    <div class="col-xs-10">
                        <input id="estacionalidad" name="estacionalidad" type="text" placeholder="" class="form-control input-sm"value="">
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="row ">
                    <div class="col-xs-10">
                        <input id="ingreso" name="ingreso" type="text" placeholder="" class="form-control input-sm"value="">
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group col-xs-6">
                        <div class="row">
                            <label class="col-xs-10 text-center ">SubTipo</label>
                        </div>
                        <div class="row">
                            <div class="dropdown col-xs-3 col-xs-offset-3">
