...
<div class="modal fade" role="dialog" id="_casonas">
  <div class="modal-dialog modal-lg " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"><b>Actualizar Casona</b></h4>
      </div>
            ...
            <div class="col-md-12 ">    
                ...
                <fieldset><br/>
                    ...
                    <div class="col-xs-12 box simple1">
                        <label class="checkbox-inline checklabel "><input type="checkbox" value="">Guiado</label>
                    ...
                    <div class="col-xs-12">
                     ...
                     <input type="hidden" name="idcasonas" value="" />
                </fieldset>
                </form>
            </div>
           </div>                
                    ...
                    <a href="<?php echo base_url(); ?>index.php/admin/casonas/save" class="btn btn-primary  col-xs-3 pull-right">Agregar</a>
                  </div>
    </div><!-- /.modal -->
     </div>
</div>
