...
<div id="contactFormWrapper">
    <div class="row">
        <div class="col-sm-4 form-group">
            ...
            <input type="text" class="form-control" id="contactFormName" name="contact[name]" placeholder="Tu nombre..." />
        </div>
        <div class="col-sm-4 form-group">
            <label class="sr-only">Email:</label>
            <input type="email" class="form-control" id="contactFormEmail" name="contact[email]" placeholder="TU email..." />
        </div>
        <div class="col-sm-4 form-group">
            <label class="sr-only">Tel&eaccute;fono Celular:</label>
            <input type="telephone" class="form-control" id="contactFormTelephone" name="contact[phone]" placeholder="tu numero celular..." />
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 form-group">
            <label class="sr-only">Mensaje:</label>
            <textarea class="form-control" rows="5" cols="75" id="contactFormMessage" name="contact[body]" placeholder="Tu mensaje..."></textarea>
        </div>
    </div>
